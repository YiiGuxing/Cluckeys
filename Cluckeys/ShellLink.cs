...
namespace Cluckeys
{
    ...
    internal interface ShellLinkFactory
    {
        internal static ShellLink GetNewInstance()
        {
            return (ShellLink) new CLSID_ShellLink();
        }

        // CLSID_ShellLink from ShlGuid.h 
        [ComImport]
        [Guid("00021401-0000-0000-C000-000000000046")]
        private class CLSID_ShellLink
        {
        }
    }
}